"use client"
import { AllStoryTopics, getStoryByTag } from '@/actions/getStories'
...
function StoryList({ allTopics, UserTags }: Props) {
...
const AddTagComp = ({ allTopics, setShowPopUp, UserTags }: TagsType) => {
